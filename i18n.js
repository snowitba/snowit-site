...
const SNOWIT_TRANSLATIONS = {
    bs: {
        ...
        'index.hero.cta.primary': 'Pozovi Enisa (WhatsApp)',
        ...
        'index.about.unique': 'Šta nas čini posebnim:',
        ...
        'usluge.ai.card1.title': 'Sigurnost AI agenata',
        ...
        // Usluge — Pricing card4 (SnowIT PRO)
        'usluge.pricing.card4.badge': 'Preporučujemo',
        'usluge.pricing.card4.name': 'SnowIT PRO',
        'usluge.pricing.card4.desc': 'Za kompleksnije projekte — sa videom, više sadržaja, SEO i održavanjem.',
        'usluge.pricing.card4.subtext': '10-14 dana isporuke',
        'usluge.pricing.card4.li1': '6 sekcija (single-page ili podstrane)',
        'usluge.pricing.card4.li2': 'Do 20 slika (selekcija + optimizacija + alt tagovi)',
        'usluge.pricing.card4.li3': '1 video embed (YouTube/Vimeo)',
        'usluge.pricing.card4.li4': 'Responsive (mobile + desktop)',
        'usluge.pricing.card4.li5': 'GMB profil uključen',
        'usluge.pricing.card4.li6': 'SEO osnovni (meta, sitemap, robots, schema.org)',
        'usluge.pricing.card4.li7': 'Google Analytics + Search Console',
        'usluge.pricing.card4.li8': '1 forma (kontakt ili upit)',
        'usluge.pricing.card4.li9': '1 mjesec besplatne podrške poslije launch-a',
        'usluge.pricing.card4.cta': 'Pozovi Enisa (WhatsApp)',

        // Usluge — CARE retainer section
        'usluge.care.label': 'Dugoročna saradnja',
        'usluge.care.h2': 'Održavanje nakon launch-a',
        'usluge.care.desc': 'Vaša web stranica treba redovno održavanje. Biramo sigurnost, ažurnost i rast za vas.',
        'usluge.care.c1.name': 'SnowIT CARE',
        'usluge.care.c1.desc': 'Osnovno održavanje — sigurnost, backup i podrška.',
        'usluge.care.c1.period': '/mjesec (min 6 mj)',
        'usluge.care.c1.li1': '2 izmjene mjesečno',
        'usluge.care.c1.li2': 'Security + plugin updates',
        'usluge.care.c1.li3': 'Weekly backup (off-site)',
        'usluge.care.c1.li4': 'Mjesečni analytics report',
        'usluge.care.c1.li5': 'Email podrška (48h response)',
        'usluge.care.c1.cta': 'Pozovi Enisa (WhatsApp)',
        'usluge.care.c2.badge': 'Preporučujemo',
        'usluge.care.c2.name': 'SnowIT CARE+',
        'usluge.care.c2.desc': 'Premium održavanje — sadržaj, SEO monitoring i priority podrška.',
        'usluge.care.c2.period': '/mjesec (min 6 mj)',
        'usluge.care.c2.li1': '5 izmjena mjesečno',
        'usluge.care.c2.li2': '1 mini sadržaj mjesečno',
        'usluge.care.c2.li3': 'SEO monitoring',
        'usluge.care.c2.li4': 'Priority podrška (24h)',
        'usluge.care.c2.li5': 'Kvartalni strategy call',
        'usluge.care.c2.cta': 'Pozovi Enisa (WhatsApp)',
        'usluge.care.info.title': 'Jednokratne izmjene',
        'usluge.care.info.li1': 'Pojedinačna izmjena: 40 KM/h',
        'usluge.care.info.li2': 'Paket 5h prepaid: 200 KM (20% popust)',
        'usluge.care.info.li3': 'Veći scope: custom quote',
        ...
        'portfolio.cs1.f1': 'Platno sučelje prilagođeno mobilnim uređajima',
        ...
        'careers.why.h2': 'Šta čini SnowIT drugačijim',
        'careers.why.c1.title': 'Smislen Rad',
        'careers.why.c1.desc': 'Vaš kod direktno utiče na njegu pacijenata. Gradite zdravstveni softver koji smanjuje administrativno opterećenje i poboljšava kliničke ishode za stvarne agencije i stvarne pacijente.',
        ...
        'careers.why.c3.title': 'Globalno iskustvo',
        ...
        'careers.culture.v1.desc': 'Isporučujemo solidan kod, ne brze zakrpe. Code reviews, testiranje, dokumentacija. Ponosni smo na ono što gradimo.',
    ...
    en: {
        ...
        // Usluge — Pricing card4 (SnowIT PRO)
        'usluge.pricing.card4.badge': 'Recommended',
        'usluge.pricing.card4.name': 'SnowIT PRO',
        'usluge.pricing.card4.desc': 'For more complex projects — with video, more content, SEO and maintenance.',
        'usluge.pricing.card4.subtext': '10-14 day delivery',
        'usluge.pricing.card4.li1': '6 sections (single-page or subpages)',
        'usluge.pricing.card4.li2': 'Up to 20 images (selection + optimisation + alt tags)',
        'usluge.pricing.card4.li3': '1 video embed (YouTube/Vimeo)',
        'usluge.pricing.card4.li4': 'Responsive (mobile + desktop)',
        'usluge.pricing.card4.li5': 'GMB profile included',
        'usluge.pricing.card4.li6': 'Basic SEO (meta, sitemap, robots, schema.org)',
        'usluge.pricing.card4.li7': 'Google Analytics + Search Console',
        'usluge.pricing.card4.li8': '1 form (contact or enquiry)',
        'usluge.pricing.card4.li9': '1 month free support after launch',
        'usluge.pricing.card4.cta': 'Contact Asmir (WhatsApp)',

        // Usluge — CARE retainer section
        'usluge.care.label': 'Long-term partnership',
        'usluge.care.h2': 'Post-launch maintenance',
        'usluge.care.desc': 'Your website needs regular maintenance. We handle security, updates, and growth for you.',
        'usluge.care.c1.name': 'SnowIT CARE',
        'usluge.care.c1.desc': 'Basic maintenance — security, backup and support.',
        'usluge.care.c1.period': '/month (min 6 mo)',
        'usluge.care.c1.li1': '2 changes per month',
        'usluge.care.c1.li2': 'Security + plugin updates',
        'usluge.care.c1.li3': 'Weekly backup (off-site)',
        'usluge.care.c1.li4': 'Monthly analytics report',
        'usluge.care.c1.li5': 'Email support (48h response)',
        'usluge.care.c1.cta': 'Contact Asmir (WhatsApp)',
        'usluge.care.c2.badge': 'Recommended',
        'usluge.care.c2.name': 'SnowIT CARE+',
        'usluge.care.c2.desc': 'Premium maintenance — content, SEO monitoring and priority support.',
        'usluge.care.c2.period': '/month (min 6 mo)',
        'usluge.care.c2.li1': '5 changes per month',
        'usluge.care.c2.li2': '1 mini content piece per month',
        'usluge.care.c2.li3': 'SEO monitoring',
        'usluge.care.c2.li4': 'Priority support (24h)',
        'usluge.care.c2.li5': 'Quarterly strategy call',
        'usluge.care.c2.cta': 'Contact Asmir (WhatsApp)',
        'usluge.care.info.title': 'One-off changes',
        'usluge.care.info.li1': 'Single change: 40 KM/h',
        'usluge.care.info.li2': '5h prepaid bundle: 200 KM (20% discount)',
        'usluge.care.info.li3': 'Larger scope: custom quote',
